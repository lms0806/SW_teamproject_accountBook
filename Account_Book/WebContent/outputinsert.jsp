	...
	<nav class = "navbar navbar-default">
		...
		<div class = "collapse navbar-collapse" id = "bs-example-navbar-collapse-1">
			<ul class = "nav navbar-nav">
				...
				<li class = "active"><a href="outputlist.jsp">지출</a><li>
	...
	<div class = "container">
		...
		<div class = "col-Lg-4">
			<div class = "jumbotron" style = "padding-top : 20px;">
				<form method = "post" action = "outputinsertaction.jsp">
					<h3 style = "text-align: center;">지출 입력</h3>
					...
					<div class = "form-group">
						<input type = "text" class = "form-control" placeholder = "금액" name = "money" maxlength = "20"> 
					</div>
					<div class = "form-group">
