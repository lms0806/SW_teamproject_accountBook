...
<body>
	...
	<nav class = "navbar navbar-default">
		...
		<div class = "collapse navbar-collapse" id = "bs-example-navbar-collapse-1">
			<ul class = "nav navbar-nav">
				...
				<li class = "active"><a href = "output.jsp">지출</a><li>
	...
	<div class="container">
		<div class = "row">
			<table class="table table-striped" style="text-align:center; border:1px solid #dddddd"> 
				...
				<tbody>
					<%
						...
						int total = 0;
						ArrayList<Output> list = outputDAO.getList(pageNumber,userID);
						for(int i = 0; i < list.size(); i++){
					%>
					<tr>
						<td><a href = "outputview.jsp?outputID=<%= list.get(i).getOutputid()%>"><%= list.get(i).getOutputid() %></a></td>				
			...
			<%
				} if(outputDAO.nextPage(pageNumber + 1, userID)){
			%>
			...
			%>
			<h3>지출 통합 : <%= total %></h3>
			<a href = "outputinsert.jsp" class="btn btn-primary pull-right">입력</a>
		</div>
	</div>
	<!-- 애니매이션 담당 JQUERY -->
